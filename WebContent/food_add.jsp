...
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath }/foodAdd" method="post">
			<!-- 填写菜名 -->
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="food_image" name="fimage" required=""
						lay-verify="required" autocomplete="off" value="images/food_menu/cold/sauce cucumber.jpg"
						class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red">*</span>
